    ...
    <div className="h-screen max:h-screen-auto flex justify-center items-center bg-gradient-to-br from-orange-500/35 via-blue-300 to-purple-400/40">
      <div className="bg-white p-8 rounded-xl shadow-lg mr-3 ml-3 mt-5 mb-5 ">
        <h1 className="font-bold text-3xl text-center m-3">
          Marathon 15.0 Registrations - Boys
        </h1>
        <form
        ...
        >
          ...
          >
            <span className="bg-orange-400 block p-4 font-semibold text-xl transition-all text-white rounded-lg -translate-y-1 translate-x-0 hover:-translate-y-2 border-2 border-black active:translate-x-0 active:translate-y-0">Submit</span>
          </button>
        </form>
      </div>
    </div>
