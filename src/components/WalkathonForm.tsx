...
const schema = z.object({
    ...
    unique_code: z.string().length(6, 'Unique code must be 6 alphanumeric characters').regex(/^[a-zA-Z0-9]+$/, 'Unique code must be alphanumeric'),
});
    ...
    return (
        <div className="h-screen max:h-screen-auto flex justify-center items-center bg-gradient-to-br from-orange-500/35 via-blue-300 to-purple-400/40">
            <div className="bg-white p-8 rounded-xl shadow-lg mr-3 ml-3 mt-5 mb-5 ">
                <h1 className='font-bold text-3xl text-center m-3'>Walkathon 15.0 Registrations</h1>
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md ${errors.unique_code ? 'border-red-500' : 'border-gray-300'}`}
                        />
                        {errors.unique_code && <p className="text-red-500 mt-1">{errors.unique_code.message}</p>}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            id="phoneNumber"
                            {...register('mobile_no')}
                            className={`w-full px-3 py-2 border rounded-md ${errors.mobile_no ? 'border-red-500' : 'border-gray-300'}`}
                        />
                        {errors.mobile_no && <p className="text-red-500 mt-1">{errors.mobile_no.message}</p>}
                    </div>
                    <div className="mb-4">
